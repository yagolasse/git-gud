...
impl VirtualScrollState {
    ...
    pub fn scroll_by(&mut self, delta: f32) {
        self.scroll_offset = (self.scroll_offset + delta).max(0.0).min(self.total_height - self.viewport_height);
    }
...
impl VirtualScroll {
    ...
    pub fn with_uniform_height(id_source: impl std::hash::Hash, total_items: usize, item_height: f32) -> Self {
        Self {
